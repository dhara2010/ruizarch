  ...
  return (
    <div className='relative min-h-screen w-full text-white'>
      ...
      <div className={`absolute top-0 left-0 h-full w-full bg-black/70 ${isScrolled ? "translate-3d" : ""}`}></div>
        ...
        <h1 className='text-6xl font-bold mt-40'>Interior Decor</h1>
        <p className='text-sm pt-10'>home <span className='mx-4'>/</span> services <span className='mx-4'>/ </span>Interior Decor</p>
      </div>
    </div>
