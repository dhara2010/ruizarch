...
const Hero = () => {
  ...
  return (
    <div className='relative min-h-screen w-full text-white'>
      ...
      <div className="relative uppercase z-10 h-full md:min-h-screen flex flex-col items-center text-center justify-center px-6 md:px-28 pt-40 lg:mt-6 ">
        <h1 className='text-6xl font-bold mt-40'>Interior Decor</h1>
        <p className='text-sm pt-10'>home <span className='mx-4'>/</span> services</p>
      </div>
    </div>
  )
}
