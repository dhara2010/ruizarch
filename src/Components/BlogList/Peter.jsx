...
function Peter() {
    ...
    return (
        <div>
            <Hero2 head={'Author: Peter Stanbridge'} text={'Peter Stanbridge'} />
                    ...
                    <div className='flex flex-col gap-8 pr-0 lg:pr-10 lg:col-span-2 w-full lg:w-180'>
                        ...
                        <div className='mt-10 flex flex-col gap-8'>
                            <div className='space-y-10'>
                                <InfoBox img={"./images/projects/1.jpg"} head={'Design with community in mind'} date={'02.02.2022'}/>
                                <InfoBox img={"./images/projects/2.jpg"} head={'The Infrastructure That Powers The World'} date={'02.01.2022'}/>
                            </div>
                        </div>
                    </div>
