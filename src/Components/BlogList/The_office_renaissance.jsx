...
function The_office_renaissance() {
    ...
    return (
        <div>
            <Hero3 img={"./images/projects/4.jpg"} text='Architecture' h1={<div className="lg:w-[1000px]">Play to Your strengths and</div>} h2="supercharge " h3="your business" />
...
export default The_office_renaissance
