...
function New_construction_and_interior_designer_idea() {
    ...
    return (
        <div>
            <Hero3 img={"./images/projects/7.jpg"} text='Technology' h1={<div className="lg:w-[1000px]">New Construction and</div>} h2="interior " h3="design idea" />
                    ...
                    <div className='flex flex-col gap-8 pr-0 lg:pr-10 lg:col-span-2 w-full lg:w-170'>
                        <div className='flex flex-col gap-6 lg:gap-12'>
                            <div ref={box1Ref} className={`flex items-center gap-3 transition-all duration-500 ease-in-out ${isBox1Visible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                                ...
                                <p className='text-sm'>Tamzyn French</p>
                                <div className="size-1.5 border border-black bg-[#bcff00] rotate-45"></div>
                                <p className='text-sm text-neutral-400'>02.03.2022</p>
                            </div>
...
export default New_construction_and_interior_designer_idea
